...
using AtividadePizzariaIsmael.Models.ViewModels.RequestDTO;
using AtividadePizzariaIsmael.Data;
...
namespace AtividadePizzariaIsmael.Controllers
{
    public class SaboresController : Controller
    {
        ...
        public IActionResult Criar(PostSaborVM saborVM)
        {
            ...
            Sabor sabor = new(saborVM.Nome, saborVM.FotoURL);
